...
bool PolicyManager::validate(const std::string& principal, const std::string& cn) {
...
void PolicyManager::addPrincipal(const std::string& principal, const std::string& cn) {
