...
public:
    ...
    bool initializeCA();
    bool generateCertificate(const std::string& common_name, const std::string& csr_pem);
...
private:
    ...
    X509* generateX509(const std::string& common_name, EVP_PKEY* key, bool is_ca = false);
