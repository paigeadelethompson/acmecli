...
namespace acme {
  ...
  public:
    ...
    Json::Value handleAccount(const std::string &account_id,
                              const Json::Value &request);
    Json::Value handleNewOrder(const Json::Value &request);
    Json::Value handleOrder(const std::string &order_id,
                            const Json::Value &request);
    Json::Value handleFinalizeOrder(const std::string &order_id,
                                    const Json::Value &request);
    Json::Value handleCertificate(const std::string &cert_id,
                                  const Json::Value &request);
  ...
  private:
    ...
    bool generateCertificate(const std::string &account_id,
                             const std::string &cn, const std::string &csr_pem);
    ...
    OM_uint32 acquireCredentials(const std::string &principal,
                                 gss_cred_id_t *cred);
    OM_uint32 acceptSecurityContext(gss_ctx_id_t *context,
